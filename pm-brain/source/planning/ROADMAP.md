...
- [ ] 01-01: Criar modelo de papéis administrativos no Supabase, helper SQL de autorização e políticas RLS para escrita de catálogos.
...
|-------|-----------|----------------|--------|-----------|
| 1. Núcleo Supabase, Papéis e Governança | v1.0 Admin/Player Foundation | 0/3 | Not started | - |
